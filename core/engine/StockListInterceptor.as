...
uint IAssistList_getDataSourceTrap(IAssistList& pThis, IV8DataSource&&& result, ITextEditor& editor, IV8Bookmark&&& bkmk,
                               uint& itemsCount, int i1, int method, int i3
#if ver >= 8.3
                               ...
                               )
{
    ...
    trStdListIntercept.swap();
    uint ures = pThis.getDataSource(result, editor, bkmk, itemsCount, i1, method, i3
#if ver >= 8.3
                        , i4, i5, i6, i7, i8, i9
#endif
                        );
